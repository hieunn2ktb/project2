...
public class SqlConstants {
    ...
    public static final String COUNT_USER = "SELECT COUNT(id) FROM book WHERE id = ?";
    ...
    public static final String CHECK_IF_ADMIN = "SELECT role_name FROM roles WHERE id = ?";
}
